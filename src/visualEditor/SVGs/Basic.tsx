        ...
        <div className="svgContainer">
            <svg xmlns="http://www.w3.org/2000/svg" width="300" height="365" viewBox={viewBox}>
                <g id="login" transform="translate(-748 1219)">
                    ...
                    <text id="Sign_In" data-name="Sign In" transform="translate(966 -1089.461)" fill="#323232" fontSize="29" fontFamily="Roboto-Regular, Roboto"><tspan x="0" y="0">Sign In</tspan></text>
                    <text id="Forgot_Username_or_Password_" data-name="Forgot Username or Password?" transform="translate(806 -887.461)" fill="#323232" fontSize="18" fontFamily="Roboto-Regular, Roboto"><tspan x="0" y="0">Forgot </tspan><tspan y="0" fill="#f47b20">Username</tspan><tspan y="0" xmlSpace="preserve"> or </tspan><tspan y="0" fill="#f47b20">Password</tspan><tspan y="0">?</tspan></text>
