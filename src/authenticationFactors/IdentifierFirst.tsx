        ...
        <div style={{display:"flex", flexDirection:"column", alignItems:"center"}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="526" height="370" viewBox={viewBox}>
                <g id="login" transform="translate(-748 1219)">
                    ...
                    <text id="Forgot_Username" data-name="Forgot Username?" transform="translate(806 -950)" fill="#323232" fontSize="18" fontFamily="Roboto-Regular, Roboto"><tspan x="0" y="0">Forgot </tspan><tspan y="0" fill="#f47b20">Username</tspan><tspan y="0">?</tspan></text>
                    ...
                    <text id="Create_Account" data-name="Create Account" transform="translate(806 -859.461)" fill="#f47b20" fontSize="21" fontFamily="Helvetica"><tspan x="0" y="0">Create Account</tspan></text>
                    <g id="Component_1" data-name="Component 1" transform="translate(1065 -890.461)">
