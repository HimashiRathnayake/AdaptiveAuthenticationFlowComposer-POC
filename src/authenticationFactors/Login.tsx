        ...
        <div className="svgContainer">
            <svg xmlns="http://www.w3.org/2000/svg" width="400" height="370" viewBox={viewBox}>
                <g id="login" transform="translate(-748 1219)">
                    ...
                    <text id="Sign_In" data-name="Sign In" transform="translate(966 -1060.461)" fill="#323232" fontSize="29" fontFamily="Roboto-Regular, Roboto"><tspan x="0" y="0">Sign In</tspan></text>
                ...
                {options.length===0 &&
                    <text x={190} y={250} className="textEmpty" id="textEmpty">
                        <tspan className="textAddAuthenticators" id="svg_1">Add authenticators </tspan>
                        <tspan className="textAddAuthenticators" id="svg_1" x={120} y={270}>to build an authentication sequence.</tspan>
                    </text>
                }
                <g transform="translate(0 -350)">
                    <svg viewBox="0 0 500 100">
                        {options.map((option: string, index:number) => {
                            let x=87, y=200+55*index;
                            return (
